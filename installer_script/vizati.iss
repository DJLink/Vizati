...
; (More Updates by David Amador) Should work property with XNA 3.1
...
#define MyAppLocation "D:\Projects\Vizati\XNA\Vizati"
...
#define WindowsInstaller3_1 "WindowsInstaller-KB893803-v2-x86.exe"
...
SetupIconFile = "D:\Projects\Vizati\XNA\Vizati\vizati.ico"
UninstallIconFile = "D:\Projects\Vizati\XNA\Vizati\vizati.ico"
...
Source: {#MyRedistLocation}\{#WindowsInstaller3_1}; DestDir: {tmp};
...
Name: {group}\Manual.pdf; Filename: "{app}\Vizati_manual.pdf"
Name: {group}\{cm:UninstallProgram,{#MyAppName}}; Filename: {uninstallexe}
Name: {commondesktop}\{#MyAppName}; Filename: {app}\{#MyAppExeName}; Tasks: desktopicon


[Run]
Filename: {tmp}\{#WindowsInstaller3_1}; Flags: skipifdoesntexist; Parameters: "/quiet /norestart"
